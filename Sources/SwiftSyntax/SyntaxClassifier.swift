...
public enum SyntaxClassification: Equatable {
...
public struct SyntaxClassifierCustomizerContext {

  fileprivate let classifier: _SyntaxClassifier
  public var visitor: SyntaxVisitor { return classifier }

  fileprivate init(classifier: _SyntaxClassifier) {
    self.classifier = classifier
  }

  public func addClassification(token: TokenSyntax, classification: SyntaxClassification) {
    classifier.classifications[token] = classification
  }
}

open class SyntaxClassifierCustomizer {

  public init() {}

  open func visit(functionCalledExpression: ExprSyntax, context: SyntaxClassifierCustomizerContext) -> SyntaxVisitorContinueKind {
    return .visitChildren
  }

  open func visit(simpleTypeIdentifierName: TokenSyntax, context: SyntaxClassifierCustomizerContext) -> SyntaxVisitorContinueKind {
    return .visitChildren
  }
}
...
fileprivate class _SyntaxClassifier: SyntaxVisitor {
  ...
  var classificationContext: SyntaxClassifierCustomizerContext {
    return SyntaxClassifierCustomizerContext(classifier: self)
  }
  ...
  let customizer: SyntaxClassifierCustomizer

  init(customizer: SyntaxClassifierCustomizer) {
...
//    }
  ...
  override func visit(_ node: FunctionCallExprSyntax) -> SyntaxVisitorContinueKind {
    ...
    if self.customizer.visit(functionCalledExpression: node.calledExpression, context: self.classificationContext) == .visitChildren {
...
//  }
  ...
  override func visit(_ node: AccessorBlockSyntax) -> SyntaxVisitorContinueKind {
    ...
    node.leftBrace.walk(self)
    node.accessorListOrStmtList.walk(self)
//    node.accessors.walk(self)
  ...
  override func visit(_ node: OperatorDeclSyntax) -> SyntaxVisitorContinueKind {
    ...
    node.identifier.walk(self)
//    if let operatorPrecedenceAndTypes = node.prece {
...
//  }
  ...
  override func visit(_ node: SimpleTypeIdentifierSyntax) -> SyntaxVisitorContinueKind {
    ...
    if self.customizer.visit(simpleTypeIdentifierName: node.name, context: self.classificationContext) == .visitChildren {
      visit(node.name,
...
public enum SyntaxClassifier {
  ...
  public static func classifyTokensInTree(
    ...
    customizer: SyntaxClassifierCustomizer = .init()
  ) -> [TokenSyntax: SyntaxClassification] {
    let classifier = _SyntaxClassifier(customizer: customizer)
